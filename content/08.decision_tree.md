...
<p align="center">
  <img src="images/Residuals_CO2_Hour" alt="Actual vs predicted values using" width="600px">
  <br>
  <strong>Figure 9:</strong> Actual vs predicted values using CO2_Emitted per Hour as a dependent variable.
</p>

<p align="center">
  <img src="images/Corr_CO2_Hour" alt="Correlation matrix created using" width="600px">
  <br>
