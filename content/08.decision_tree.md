...
<p align="center">
  <img src="images/Actual_Predicted_CO2_Emission_Hour.png" alt="Actual vs predicted values using CO2_Emitted/Hour as a dependent variable." width="600px">
  <br>
  <strong>Figure 9:</strong> Actual vs predicted values using CO2_Emitted/Hour as a dependent variable.
</p>

<p align="center">
  <img src="images/Correlation_Mat_CO2_Emissions_Hour.png" alt="Correlation matrix created using CO2_Emitted/Hour as a dependent variable" width="600px">
  <br>
